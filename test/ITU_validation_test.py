...
#    suite.addTest(ITUR618_13TestCase('test_site_diversity'))
    ...
    suite.addTest(ITUR618_14TestCase('test_rain_attenuation'))
    suite.addTest(ITUR618_14TestCase('test_probability_of_rain_attenuation'))
    suite.addTest(ITUR618_14TestCase('test_site_diversity_regression'))
    suite.addTest(ITUR618_14TestCase('test_scintillation_attenuation'))
    suite.addTest(ITUR618_14TestCase(
        'test_rain_cross_polarization_discrimination'))
    suite.addTest(ITUR618_14TestCase('test_total_attenuation'))
...
class ITUR837_7TestCase(test.TestCase):
    ...
    def test_rainfall_rate_R001(self):
        ...
        self.assertAlmostEqual(
            models.itu837.rainfall_rate(3.133, 101.7, 0.01, 'approx').value,
            99.1481136, places=5)
        self.assertAlmostEqual(
            models.itu837.rainfall_rate(22.9, -43.23, 0.01, 'approx').value,
            50.639304, places=5)
        self.assertAlmostEqual(
            models.itu837.rainfall_rate(23.0, 30.0, 0.01, 'approx').value,
            0.0, places=5)
        self.assertAlmostEqual(
            models.itu837.rainfall_rate(25.78, -80.22, 0.01, 'approx').value,
            78.2982928, places=5)
        self.assertAlmostEqual(
            models.itu837.rainfall_rate(28.717, 77.3, 0.01, 'approx').value,
            63.5972464, places=5)
        self.assertAlmostEqual(
            models.itu837.rainfall_rate(33.94, 18.43, 0.01, 'approx').value,
            27.1349664, places=5)
        self.assertAlmostEqual(
            models.itu837.rainfall_rate(41.9, 12.49, 0.01, 'approx').value,
            33.936232, places=5)
        self.assertAlmostEqual(
            models.itu837.rainfall_rate(51.5, -0.14, 0.01, 'approx').value,
            26.48052, places=5)
...
class ITUR618_13TestCase(test.TestCase):
    ...
    def setUp(self):
        models.itu453.change_version(13)
        models.itu618.change_version(13)
        models.itu676.change_version(11) # 12,13
        models.itu836.change_version(6)
        models.itu837.change_version(7)
        models.itu838.change_version(3)
        models.itu839.change_version(4)
        models.itu840.change_version(7) #7, 8
        models.itu1510.change_version(1)
        models.itu1511.change_version(1) # 1,2
...
class ITUR618_14TestCase(test.TestCase):
