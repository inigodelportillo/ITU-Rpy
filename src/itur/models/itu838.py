...
from iturutils import prepare_quantity
...
class __ITU838():
    ...
    * P.838-3 (03/05) (Current version)
    ...
    def rain_specific_attenuation(self, R, f, el, tau):
        ...
        k, alpha = self.instance.rain_specific_attenuation_coefficients(f, el, tau)
        return k*R**alpha
...
class _ITU838_1():
    ...
    def rain_specific_attenuation_coefficients(self, f, el, tau):
        ...
        _kV = [0.0000352, 0.000138, 0.000591, 0.00155, 0.00265, 0.00395, 0.00887,
              0.0168, 0.0335, 0.0691, 0.113, 0.167, 0.233, 0.31, 0.393, 0.479,
              0.642, 0.784, 0.906, 0.999, 1.06, 1.13, 1.27, 1.42, 1.35, 1.31]

        _alphaH = [0.912, 0.963, 1.121, 1.308, 1.332, 1.327, 1.276, 1.217, 1.154,
                  1.099, 1.061, 1.021, 0.979, 0.939, 0.903, 0.873, 0.826, 0.793,
                  0.769, 0.753, 0.743, 0.731, 0.71, 0.689, 0.688, 0.683]
