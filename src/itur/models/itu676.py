...
from models.itu453 import radio_refractive_index
from models.itu835 import standard_pressure, standard_temperature
from models.itu836 import total_water_vapour_content
from iturutils import prepare_quantity, prepare_output_array,\
...
class __ITU676():
    ...
    * P.676-11 (09/16) (Current version)
    ...
    def gaseous_attenuation_terrestrial_path(self,  r, f, el, rho, P, T, mode):
        ...
        return self.instance.gaseous_attenuation_terrestrial_path(r, f, el, rho, P, T, mode)

    def gaseous_attenuation_slant_path(self, f, el, rho, P, T, mode):
        # Abstract method to compute the gaseous attenuation over a slant path
        return self.instance.gaseous_attenuation_slant_path(f, el, rho, P, T, mode)
...
class _ITU676_10():
    ...
    def gaseous_attenuation_approximation(self, f, el, rho, P, T):
        ...
        """
        if f > 350:
            warnings.warn(RuntimeWarning('The approximated method to computes '
        ...
        if  (5 > el).any() or (np.mod(el, 90) < 5).any():
            warnings.warn(RuntimeWarning('The approximated method to compute '
                      'the gaseous attenuation in recommendation ITU-P 676-11 '
