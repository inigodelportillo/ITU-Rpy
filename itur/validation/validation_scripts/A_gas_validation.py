...
def gaseous_attenuation_validation():
    ...
    print("Average: " + str(hOAvg) + " km")
    print("Max: " + str(hOMax) + " km")
    print("Average Percent Error: " + str(hOAvgPE))    
    
    print()
    print ("Attenuation due to Oxygen (A_O): ")
    print("Average: " + str(aOAvg) + " dB")
    print("Max: " + str(aOMax) + " dB")
    print("Average Percent Error: " + str(aOAvgPE)) 
    
    print()
    print ("A_O / sin(Elevation Angle): ")
    print("Average: " + str(aOsinAvg) + " dB")
    print("Max: " + str(aOsinMax) + " dB")
    print("Average Percent Error: " + str(aOsinAvgPE))     
    ...
    print("Average: " + str(aWAvg) + " dB")
    print("Max: " + str(aWMax) + " dB")
    print("Average Percent Error: " + str(aWAvgPE))   
    
    print()
    print ("A_W / sin(Elevation Angle): ")
    print("Average: " + str(aWsinAvg) + " dB")
    print("Max: " + str(aWsinMax) + " dB")
    print("Average Percent Error: " + str(aWsinAvgPE))     
    
        
    print()
    print ("Rho_ref: ")
    print("Average: " + str(rhoRefAvg) + " g/m^3")
    print("Max: " + str(rhoRefMax) + " g/m^3")
    print("Average Percent Error: " + str(rhoRefAvgPE))  
      
    print()
    print ("t_ref: ")
    print("Note: The error in t_red comes from the +3 constant in the algorithm.")
    print("It does not seem like the validation data includes this constant.")
    print("Average: " + str(tRefAvg) + " degrees C")
    print("Max: " + str(tRefMax) + " degrees C")
    print("Average Percent Error: " + str(tRefAvgPE))  
