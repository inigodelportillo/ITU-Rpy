...
class __ITU1510__:
    ...
    * P.1510-0 (02/01) (Current version)
    ...
    def surface_month_mean_temperature(self, lat, lon, m):
        ...
        fcn = np.vectorize(
            self.instance.surface_month_mean_temperature,
            excluded=[0, 1],
            otypes=[np.ndarray],
        )
...
class _ITU1510_1_:
    def __init__(self):
        ...
        self.month = 6
        self.link = (
            "https://www.itu.int/rec/R-REC-P.1510/"
    ...
    def temperature(self, lat, lon):
        ...
        return self._temperature(np.array([lat.ravel(), lon.ravel()]).T).reshape(
            lat.shape
        )
...
class _ITU1510_0_:
    ...
    def surface_month_mean_temperature(self, lat, lon, m):
        raise NotImplementedError(
            "The monthly mean temperature is not"
