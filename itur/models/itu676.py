...
class _ITU676_12_():
    ...
    def gaseous_attenuation_slant_path(self, f, el, rho, P, T, V_t=None,
        ...
        if mode == 'approx':
            ...
            # Use Eq. 11 of ITU-R P.676-12 with scipy.integrate.quad.
            # This avoids the step-based approximation and correctly handles
            # the case when h > 0 (i.e. the earth station is not at sea level).
