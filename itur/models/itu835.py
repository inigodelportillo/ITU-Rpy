...
class _ITU835_6():
    ...
    def standard_temperature(self, h, T_0=288.15):
        ...
        T = np.where(h_p <= 11, 288.15 - 6.5 * h_p,
            np.where(np.logical_and(11 <= h_p, h_p < 20), 216.65,
            np.where(np.logical_and(20 <= h_p, h_p < 32), 216.65 + (h_p - 20),
            np.where(np.logical_and(32 <= h_p, h_p < 47), 216.65 + 2.8 * (h_p - 32),
            np.where(np.logical_and(47 <= h_p, h_p < 51), 270.65,
            np.where(np.logical_and(51 <= h_p, h_p < 71), 270.65 - 2.8 * (h_p - 51),
            np.where(np.logical_and(71 <= h_p, h_p < 84.852), 214.65 - 2.0 * (h_p - 71),
            np.where(np.logical_and(86 <= h, h < 91), 186.8673,
    ...
    def standard_pressure(self, h, T_0=None, P_0=None):
        ...
        """
        h_p = 6356.766 * h / (6356.766 + h)
        P = np.where(h_p <= 11, 1013.25 * (288.15 / (288.15 - 6.5 * h_p)) ** (-34.1632 / 6.5),
            np.where(np.logical_and(11 <= h_p, h_p < 20), 226.3226 * np.exp(-34.1632 * (h_p - 11) / 216.65),
            np.where(np.logical_and(20 <= h_p, h_p < 32), 54.74980 * (216.65 / (216.65 + (h_p - 20))) ** (34.1632),
            np.where(np.logical_and(32 <= h_p, h_p < 47), 8.680422 * (228.65 / (228.65 - 2.8 * (h_p - 32))) ** (34.1632 / 2.8),
            np.where(np.logical_and(47 <= h_p, h_p < 51), 1.109106 * np.exp(-34.1632 * (h_p - 47) / 270.65),
            np.where(np.logical_and(51 <= h_p, h_p < 71), 0.6694167 * (270.65 / (270.65 - 2.8 * (h_p - 51))) ** (-34.1632 / 2.8),
            np.where(np.logical_and(71 <= h_p, h_p < 84.852), 0.03956649 * (214.65 / (214.65 - 2.0 * (h_p - 71))) ** (-34.1632 / 2.0),
