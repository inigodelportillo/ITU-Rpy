...
from itur.models.itu838 import (
...
class __ITU530__:
    ...
    def inverse_rain_attenuation(self, lat, lon, d, f, el, Ap, tau=45, R001=None):
        return self.instance.inverse_rain_attenuation(lat, lon, d, f, el, Ap, tau, R001)
    ...
    def XPD_outage_clear_air(self, lat, lon, h_e, h_r, d, f, XPD_g, C0_I, XPIF=0):
        return self.instance.XPD_outage_clear_air(
            lat, lon, h_e, h_r, d, f, XPD_g, C0_I, XPIF
        )

    def XPD_outage_precipitation(self, lat, lon, d, f, el, C0_I, tau=45, U0=15, XPIF=0):
        return self.instance.XPD_outage_precipitation(
            lat, lon, d, f, el, C0_I, tau, U0, XPIF
        )
...
class _ITU530_17_:
    ...
    def s_a(self, lat, lon):
        ...
        if not _ITU530_17_._s_a:
            _ITU530_17_._s_a = load_data_interpolator(
                "530/v16_lat.npz",
                "530/v16_lon.npz",
                "530/v16_gtopo_30.npz",
                bilinear_2D_interpolator,
                flip_ud=False,
            )

        return _ITU530_17_._s_a(np.array([lat.ravel(), lon.ravel()]).T).reshape(
            lat.shape
        )
    ...
    def rain_attenuation(self, lat, lon, d, f, el, p, tau=45, R001=None):
        ...
        r = 1 / (
            0.477 * d**0.633 * R001 ** (0.073 * alpha) * f ** (0.123)
    ...
    def rain_event_count(self, lat, lon, d, f, el, A, tau=45, R001=None):
        ...
        p_A = self.inverse_rain_attenuation(
            lat, lon, d, f, el, Ap=A, tau=tau, R001=R001
        )
